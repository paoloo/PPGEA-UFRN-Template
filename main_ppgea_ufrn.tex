...
% DADOS DO TRABALHO
% ------------------------------------------------------------
% Ajuste APENAS este bloco para preencher autor, título,
% orientação, instituição e banca examinadora. Estas informações
% alimentam automaticamente a capa, a folha de rosto, a ficha
% catalográfica e a folha de aprovação.
% ============================================================
\autor{Autor}
\titulo{Modelo de Dissertação PPgEA com \abnTeX}
\orientador{Orientador}
\coorientador{Coorientador} % se não houver coorientador, comente ou apague esta linha
\local{Natal}
\data{\the\year}
...
% Data e membros da banca examinadora (folha de aprovação)
\newcommand{\dataDefesa}{01 de janeiro de 2030}
\newcommand{\bancaConvidadoUm}{Nome do Professor Convidado 1}
\newcommand{\bancaConvidadoDois}{Nome do Professor Convidado 2}
%\newcommand{\bancaConvidadoTres}{Nome do Professor Convidado 3}
%\newcommand{\bancaConvidadoQuatro}{Nome do Professor Convidado 4}
% ============================================================
...
% Ficha bibliografica
% ---------------------------------------------------------------------
\input{elementos_pre_textuais/ficha_catalografica} 
...
\input{elementos_pre_textuais/folha_aprovacao}
...
\begin{apendicesenv}
    ...
    \include{elementos_pos_textuais/apend_B}
\end{apendicesenv}
...
\begin{anexosenv}
  % Imprime uma página indicando o início dos anexos
    ...
    \include{elementos_pos_textuais/anex_B}
